...
import { createOrder, type CreateOrderInput } from '@/app/repository/orders-repository';
    ...
    async onSubmit(event: React.FormEvent<HTMLFormElement>) {
      ...
      try {
        ...
        const input: CreateOrderInput = {
          ...
          requiredLicensesCertification: getStr('requiredLicensesCertification') || null,
          requiredInsuranceCoverage: getStr('requiredInsuranceCoverage') || null,
        };
  ...
  return (
    <form {...form.props} className="space-y-6">
      <div className="space-y-2">
        ...
        <Input id="title" name="title" placeholder="例: 渋谷商業ビル新築工事" defaultValue={fields.title.value} />
      ...
      <div className="space-y-2">
        ...
        />
        {fields.description.errors && <p className="text-sm text-destructive">{fields.description.errors}</p>}
      </div>
      ...
      <div className="space-y-2">
        ...
        {fields.propertyTypeId?.errors && (
          <p className="text-sm text-destructive">{fields.propertyTypeId.errors}</p>
        )}
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <div className="space-y-2">
          ...
          {fields.prefectureId?.errors && (
            <p className="text-sm text-destructive">{fields.prefectureId.errors}</p>
          )}
        </div>
        ...
        <div className="space-y-2">
          ...
          <Input id="city" name="city" placeholder="渋谷区" defaultValue={fields.city.value} />
          {fields.city.errors && <p className="text-sm text-destructive">{fields.city.errors}</p>}
        </div>
      </div>
      ...
      <div className="space-y-2">
        ...
        {fields.constructionTypeId?.errors && (
          <p className="text-sm text-destructive">{fields.constructionTypeId.errors}</p>
        )}
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <div className="space-y-2">
          ...
          <Input id="laborBudget" name="laborBudget" type="number" placeholder="10000000" />
          {fields.laborBudget?.errors && (
            <p className="text-sm text-destructive">{fields.laborBudget.errors}</p>
          )}
        </div>

        <div className="space-y-2">
          <Label htmlFor="estimateBudget">概算見積（千円単位）</Label>
          <Input id="estimateBudget" name="estimateBudget" type="number" placeholder="1500" />
          <p className="text-xs text-muted-foreground">任意: 概算見積（例: 1500 は 1,500,000 円）</p>
        </div>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <div className="space-y-2">
          ...
          <Input id="constructionStartDate" name="constructionStartDate" type="date" />
          {fields.constructionStartDate?.errors && (
            <p className="text-sm text-destructive">{fields.constructionStartDate.errors}</p>
          )}
        </div>
        ...
        <div className="space-y-2">
          ...
          <Input id="constructionEndDate" name="constructionEndDate" type="date" />
          {fields.constructionEndDate?.errors && (
            <p className="text-sm text-destructive">{fields.constructionEndDate.errors}</p>
          )}
        </div>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <div className="space-y-2">
          ...
          {fields.applicationStartDate?.errors && (
            <p className="text-sm text-destructive">{fields.applicationStartDate.errors}</p>
          )}
        </div>
        <div className="space-y-2">
          ...
          {fields.applicationEndDate?.errors && (
            <p className="text-sm text-destructive">{fields.applicationEndDate.errors}</p>
          )}
        </div>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <div className="space-y-2">
          ...
          {fields.contractorPosition?.errors && (
            <p className="text-sm text-destructive">{fields.contractorPosition.errors}</p>
          )}
        </div>
        <div className="space-y-2">
          ...
          {fields.paymentClosingDate?.errors && (
            <p className="text-sm text-destructive">{fields.paymentClosingDate.errors}</p>
          )}
        </div>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <div className="space-y-2">
          ...
          {fields.paymentDueMonth?.errors && (
            <p className="text-sm text-destructive">{fields.paymentDueMonth.errors}</p>
          )}
        </div>
        <div className="space-y-2">
          ...
          {fields.paymentDueDate?.errors && (
            <p className="text-sm text-destructive">{fields.paymentDueDate.errors}</p>
          )}
        </div>
      </div>
      ...
      <div className="space-y-2">
        <div className="flex items-center gap-3">
          <input id="canPayBeforeStart" name="canPayBeforeStart" type="checkbox" className="h-4 w-4" />
      ...
      <div className="space-y-2">
        ...
        <Textarea id="workScope" name="workScope" placeholder="例: 電気工事、管工事、内装工事の協力会社募集" />
      </div>

      <div className="space-y-2">
        <Label htmlFor="requiredLicensesCertification">必要な資格・免許（任意）</Label>
        <Textarea id="requiredLicensesCertification" name="requiredLicensesCertification" placeholder="例: 第一種電気工事士" />
      </div>

      <div className="space-y-2">
        <Label htmlFor="requiredInsuranceCoverage">必要な保険（任意）</Label>
        <Textarea id="requiredInsuranceCoverage" name="requiredInsuranceCoverage" placeholder="例: 労災保険、賠償責任保険" />
      </div>
